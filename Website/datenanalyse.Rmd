...
Die folgende Grafik zeigt die Verteilung der Impfstoffe pro Jahr. Auffällig ist, dass in 2020 kein Janssen verimpft wurde. Dies lässt darauf schließen, dass Moderna, Comirnaty und AstraZeneca die ersten freigegebenen Impfstoffe waren. In 2021 fällt, wie in der vorhergehenden Grafik, der große Anteil des Impfstoffs Cominaty auf.
...
ggplotly(graph_11) %>%
  layout(title = list(text = paste0("Mobilitätsaufkommen",
                                    '<br>',
                                    '<sup>',
                                     "An Orten wie Parks und Naherholungsgebiete",'</sup>')))
```
...
ggplotly(graph_12) %>%
  layout(title = list(text = paste0("Mobilitätsaufkommen",
                                    '<br>',
                                    '<sup>',
                                     "An Orten wie öffentliche Verkehrsmittel",'</sup>')))
```
...
mobility_vaccine %>%
  ...
  labs(
    title = "Mobilitätsaufkommen vs Impfverlauf",
    subtitle = "An Orten wie Läden des täglichen Bedarfs",
    y = "Abweichung zum Rezerenzwert [%]"
  )
...
mobility_vaccine %>%
  ...
  labs(
    title = "Mobilitätsaufkommen vs Impfverlauf",
    subtitle = "An Orten wie Parks, Schlössern etc.",
    y = "Abweichung zum Rezerenzwert [%]"
  )
...
mobility_vaccine %>%
  ...
  labs(
    title = "Mobilitätsaufkommen vs Impfverlauf",
    subtitle = "An Orten wie Transitstationen",
    y = "Abweichung zum Rezerenzwert [%]"
  )
