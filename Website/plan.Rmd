...
Ziel soll es sein eine Map von Deuschland zu generieren und die Veränderung von geimpften Personenaufkommen über die Zeit zu betrachten. Daraus lässt sich dann ableiten welche die Orte sind, andenen das höchste aufkommen von ungeimpften Personen stattfindet. Da diese Orte ein großes Potential für die Verbreitung des COVID-Virus sind ist es wichtig die Impfquote an diesen zu erhöhen.
...
Die Wichtigsten Variablen für uns ist die Anzahl der geimpften Menschen sowie das Personenaufkommen in den einzelnen Regionen. Diese sind in folgende Unergruppen unterteilt:
...
Die Daten für die geimpften Personen liegen separiert nach dem Impfstoff vor. Für unsere Betrachtung spielt es jedoch keine Rolle welchen Impfstoff die betreffende Person erhalten hat.
